...
The data dictionary contains meanings of abbreviations. Some frequent ones are loc (local), IC (incoming), OG (outgoing), T2T (telecom operator to telecom operator), T2O (telecom operator to another operator), RECH (recharge) etc.(refer file Data+Dictionary+Telecom+Churn.xlsx)


The attributes containing 6, 7, 8, 9 as suffixes imply that those correspond to the months 6, 7, 8, 9 respectively. 

Data Preparation
The following data preparation steps are performed for this problem:

1. Derive new features
This is one of the most important parts of data preparation since good features are often the differentiators between good and bad models. Use wer business understanding to derive features we think could be important indicators of churn.
...
Finally, recommend strategies to manage customer churn based on wer observations.

Tools and Libraries Used: 
Python3, Numpy, Pandas, Matplotlib, Seaborn, Sklearn, Imblearn etc.

Key Learnings: EDA, Data Preprocessing, Model Building, Hyper-parameter Tuning, Handeling class imbalance
